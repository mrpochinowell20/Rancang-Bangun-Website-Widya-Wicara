@extends('admin.layouts.app', [
  'elementActive' => 'detail'
])

@section('title', 'Detail | Data solution');

@section('content')
<div>
  <div class = "row">
      <div class = "col-md-12">
        <h1>Detail solution<h1>
      </div>
      <div class="col-md-12">
        <div class="container-fluid bg-white p-4">
          <div class="mb-4">
            <table>
                ...
                <tr>
                    <th width="100px">Subtitle</th>
                    <th width="30px">:</th>
                    <th>{{$solution->subtitle}}</th>
                </tr>
                <tr>
                    <th width="100px">Descriptions</th>
                    <th width="30px">:</th>
                    <th>{{$solution->deskriptions}}</th>
                </tr>
                <tr>
                    <th width="100px">icon</th>
                    <th width="30px">:</th>
                    <th> <img  id="image-preview-update" width="250px" height="250px" src="/data_file/{{$solution->icon}}" alt=""></th>
                </tr>
            </table>
  ...
  <script>
    $(function() {
        var table = $('.yajra-datatable').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('solution.detail.list', $solution->id) }}",
            columns: [
            {data: 'nama', name: 'nama'},
